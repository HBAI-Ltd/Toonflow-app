...
**Quy tắc 6 giây vàng**: cú máy 无台词 (không có thoại) mà cộng dồn quá 6s vẫn chưa có thông tin mới (thoại/hành động/đổi chủ thể) thì sự chú ý của khán giả đứt gãy. Đặc biệt lưu ý với các cú định cảnh và chuyển tiếp, thà gộp lại nén lại chứ đừng lê thê
...
**description** (Mô tả hình ảnh): một câu mô tả nội dung cốt lõi của khung hình (20~70 chữ), gồm **chủ thể + hành động/trạng thái + không gian môi trường** nhìn thấy được, không viết hoạt động tâm lý. Phải thể hiện được lớp lang không gian (dính ít nhất hai lớp trong tiền cảnh/trung cảnh (中景)/hậu cảnh). Như "tiền cảnh rèm the khẽ lay, trung cảnh (中景) xe ngựa hầu phủ tới trước viện hoang trên núi Lạc Nhạn", "vú Thành nhảy xuống xe ngựa, đưa mắt nhìn khu viện đổ nát, xa xa rặng núi chìm vào bóng chiều"
...
- Cảnh không người và đặc tả (特写) vật thể thuần thì điền `—`
...
- Cú máy một nhân vật có thể chỉ điền một mục `nhân vật(vị trí)` hoặc điền `—`; đặc tả (特写) vật thể thuần, cảnh không người thì điền `—`
...
| 左中 | Bên trái khung, lớp trung cảnh (中景) | Vị trí trái ở dải giữa của nhóm người |
| 中中 | Chính giữa khung, lớp trung cảnh (中景) | Chủ thể cốt lõi ở giữa, người chủ đạo cuộc đối thoại |
| 右中 | Bên phải khung, lớp trung cảnh (中景) | Vị trí phải ở dải giữa của nhóm người |
...
**duration**: tham chiếu cơ bản —— 特写/biểu cảm 2~3s · 近景 đối thoại 3~5s · phô toàn thân 3~5s · hành động 2~4s · 远景/cảnh không người/chuyển tiếp 3~5s · cảnh phức tạp 5~8s. **Một cú máy không quá 8s**, quá thì phải tách.
...
**lines**: nguyên văn thoại của nhân vật, **bắt buộc bê nguyên từ kịch bản, không đổi một chữ**. Nhiều nhân vật thì xếp theo định dạng `tên nhân vật: câu thoại`. 无台词 (không có thoại) thì điền `无台词`. Một câu thoại ứng với một cú máy, tránh nhét nhiều lượt đối đáp của nhiều nhân vật vào một cú.

...
|------|------|------|
| `videoDesc` | `string` | Mô tả hình ảnh, Bối cảnh, Tên tài nguyên liên quan, Thời lượng, Cỡ cảnh, Chuyển động máy quay, Hành động nhân vật, Cảm xúc, Ánh sáng và không khí, Thoại, Hiệu ứng âm thanh, ID tài nguyên liên quan (**chế độ đa tham chiếu có hỗ trợ bảng phân cảnh** thì đây là văn bản cố định 「固定」) |
...
Lấy mỗi «nhóm» của bảng phân cảnh làm đơn vị, ghép và ghi vào `videoDesc` theo **thứ tự cố định** (固定) sau:
...
- **videoDesc bắt buộc điền**: `videoDesc` của mỗi phân cảnh bắt buộc phải được sinh từ dữ liệu phân cảnh của dòng tương ứng trong `storyboardTable`, chứa đầy đủ thông tin gồm Mô tả hình ảnh, Bối cảnh, Tên tài nguyên liên quan, Thời lượng, Cỡ cảnh, Chuyển động máy quay, Hành động nhân vật, Hướng nhìn, Quan hệ không gian, Cảm xúc, Thoại, Hiệu ứng âm thanh, ID tài nguyên liên quan (**chế độ đa tham chiếu có hỗ trợ bảng phân cảnh là ngoại lệ** —— `videoDesc` là văn bản cố định (固定) `参考故事板内容进行视频生成`, thông tin hình ảnh do ảnh bảng phân cảnh gánh)

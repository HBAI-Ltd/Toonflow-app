...
> **Nguyên tắc cốt lõi**: derive là **biến thể trạng thái thị giác** của tài nguyên cha ("{tên tài nguyên cha}·{tên trạng thái}"), **không phải** một vật thể độc lập, cũng không phải một cận cảnh cục bộ (局部特写) tách ra tạm cho một cú máy nào đó.

// @routes-hash 9b5a122688c14ed7cc2e49ff2d0351f4
import { Express } from "express";

import route1 from "./routes/agents/clearMemory";
import route2 from "./routes/agents/getConversation";
import route3 from "./routes/agents/getMemory";
...
export default async (app: Express) => {
  ...
  app.use("/api/agents/getConversation", route2);
  app.use("/api/agents/getMemory", route3);

...
- ✅ **無限キャンバス制作ワークベンチ**  
  無限キャンバス状に脚本、キャラクター、絵コンテ、素材、動画ノードを整理。左側の Agent チャットでタスクを進め、中央キャンバスで生成リンクを追跡し、右側 Inspector でノードの事実、バージョン、出典、確定操作を管理します。
- ✅ **3層エージェント協調システム**  
...
5. クリエイティブキャンバスに入り、「脚本 / キャラクター・シーン・小道具 / 絵コンテ / 動画 / 監査」タブを切り替え、左側 Agent チャットとキャンバスノード操作で各工程を進めます。

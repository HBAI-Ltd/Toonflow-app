...
- ✅ **เวิร์กสเตชันการผลิตแบบผืนผ้าใบไม่จำกัด**  
  จัดระเบียบสคริปต์ ตัวละคร สตอรี่บอร์ด แอสเซ็ต และโหนดวิดีโอในรูปแบบผืนผ้าใบไม่จำกัด โดยแชต Agent ด้านซ้ายขับเคลื่อนงาน ผืนผ้าใบกลางติดตามสายการสร้าง และ Inspector ด้านขวาเก็บข้อเท็จจริงของโหนด เวอร์ชัน แหล่งที่มา และคำสั่งที่แน่นอน
...
5. เข้าไปที่ผืนผ้าใบสร้างสรรค์ สลับแท็บ Script / Assets / Storyboard / Video / Audit และขับเคลื่อนแต่ละขั้นตอนผ่านแชต Agent ด้านซ้ายกับคำสั่งบนโหนดในผืนผ้าใบ

...
- **Node.js**: 24.x (`24 LTS` рекомендуется как базовая версия для полной установки и сборки репозитория)
- **ОЗУ**: 2 ГБ и более
...
|------------------------|-----------------------------------------------------------------------------------------|
| Runtime                | Node.js 24.x (для локальной разработки рекомендуется 24 LTS) |
| Язык                   | TypeScript 5.x |
...
- **Node.js**: для локальной разработки рекомендуется `24 LTS`
- **Yarn**: `1.x Classic`

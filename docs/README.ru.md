...
- ✅ **Бесконечный холст для производства**  
  Организация сценариев, персонажей, раскадровок, материалов и видеоузлов в формате бесконечного холста: чат Agent слева запускает задачи, центральный холст показывает связи генерации, а правый Inspector хранит факты узла, версии, источники и детерминированные действия.
...
5. Откройте творческий холст, переключайтесь между вкладками Script / Assets / Storyboard / Video / Audit и продвигайте этапы через левый чат Agent и действия узлов на холсте.
